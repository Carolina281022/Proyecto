...
<head>
  ...
  <style>
    ...
    .sidebar .logo-container, .logo-title-center {
    ...
    .rating-container, .contact-info, .form-container {
      background: #f9f9f9;
      border-radius: 16px;
      padding: 2.5rem 2rem 2rem 2rem;
      box-shadow: 0 2px 8px rgba(0,0,0,0.08);
    ...
    .contact-info h2, .rating-container h2 {
      margin-top: 0;
      color: #005744;
      font-size: 1.5rem;
    ...
    @media (max-width: 1100px) {
      .main-content, #detalles, .contenedor {
        max-width: 98vw;
      }
      #detalles ul {
    ...
    @media (max-width: 700px) {
      ...
      .contact-info, .rating-container, .form-container, .wide-container {
        max-width: 98vw;
      }
    }
    footer {
...
<body>
  ...
  <div class="global-header">
    <img src="logo.png" alt="Helping Hands Logo" class="logo-global">
  ...
  <script>
    ...
    const profesiones = {
      chefs: {
        ...
        profesionales: [
          {nombre: 'Carlos Ramírez', foto: 'https://randomuser.me/api/portraits/men/1.jpg', experiencia: 8},
          {nombre: 'María González', foto: 'https://randomuser.me/api/portraits/women/1.jpg', experiencia: 5},
          {nombre: 'Pedro Chef', foto: 'https://randomuser.me/api/portraits/men/15.jpg', experiencia: 12}
        ]
      },
      enfermeros: {
        ...
        profesionales: [
          {nombre: 'Ana López', foto: 'https://randomuser.me/api/portraits/women/2.jpg', experiencia: 7},
          {nombre: 'Juan Pérez', foto: 'https://randomuser.me/api/portraits/men/2.jpg', experiencia: 10},
          {nombre: 'Sandra Nurse', foto: 'https://randomuser.me/api/portraits/women/11.jpg', experiencia: 4}
        ]
      },
      constructores: {
        ...
        profesionales: [
          {nombre: 'Roberto Silva', foto: 'https://randomuser.me/api/portraits/men/3.jpg', experiencia: 15},
          {nombre: 'Miguel Torres', foto: 'https://randomuser.me/api/portraits/men/4.jpg', experiencia: 9},
          {nombre: 'Luis Constructor', foto: 'https://randomuser.me/api/portraits/men/16.jpg', experiencia: 20}
        ]
      },
      plomeros: {
        titulo: 'Plomeros',
        ...
        profesionales: [
          {nombre: 'Luis Morales', foto: 'https://randomuser.me/api/portraits/men/5.jpg', experiencia: 11},
          {nombre: 'Pedro Sánchez', foto: 'https://randomuser.me/api/portraits/men/6.jpg', experiencia: 6},
          {nombre: 'Mario Plomero', foto: 'https://randomuser.me/api/portraits/men/17.jpg', experiencia: 13}
        ]
      },
      electricistas: {
        ...
        profesionales: [
          {nombre: 'José García', foto: 'https://randomuser.me/api/portraits/men/7.jpg', experiencia: 14},
          {nombre: 'Ricardo Díaz', foto: 'https://randomuser.me/api/portraits/men/8.jpg', experiencia: 8},
          {nombre: 'Elena Luz', foto: 'https://randomuser.me/api/portraits/women/12.jpg', experiencia: 5}
        ]
      },
      cerrajeros: {
        titulo: 'Cerrajeros',
        ...
        profesionales: [
          {nombre: 'Fernando Ruiz', foto: 'https://randomuser.me/api/portraits/men/9.jpg', experiencia: 10},
          {nombre: 'Alberto Castro', foto: 'https://randomuser.me/api/portraits/men/10.jpg', experiencia: 7},
          {nombre: 'Sonia Llaves', foto: 'https://randomuser.me/api/portraits/women/13.jpg', experiencia: 6}
        ]
      },
      generales: {
        ...
        profesionales: [
          {nombre: 'Carmen Rojas', foto: 'https://randomuser.me/api/portraits/women/3.jpg', experiencia: 9},
          {nombre: 'Diana Vargas', foto: 'https://randomuser.me/api/portraits/women/4.jpg', experiencia: 7},
          {nombre: 'Jorge General', foto: 'https://randomuser.me/api/portraits/men/18.jpg', experiencia: 12}
        ]
      },
      manicuristas: {
        ...
        profesionales: [
          {nombre: 'Laura Mendoza', foto: 'https://randomuser.me/api/portraits/women/5.jpg', experiencia: 6},
          {nombre: 'Patricia López', foto: 'https://randomuser.me/api/portraits/women/6.jpg', experiencia: 8},
          {nombre: 'Estefanía Nails', foto: 'https://randomuser.me/api/portraits/women/14.jpg', experiencia: 4}
        ]
      },
      domiciliarios: {
        ...
        profesionales: [
          {nombre: 'Andrés Torres', foto: 'https://randomuser.me/api/portraits/men/11.jpg', experiencia: 3},
          {nombre: 'Carlos Mendez', foto: 'https://randomuser.me/api/portraits/men/12.jpg', experiencia: 5},
          {nombre: 'Domi Express', foto: 'https://randomuser.me/api/portraits/men/19.jpg', experiencia: 7}
        ]
      },
      psicologos: {
        titulo: 'Psicólogos',
        ...
        profesionales: [
          {nombre: 'Sofía Ramírez', foto: 'https://randomuser.me/api/portraits/women/7.jpg', experiencia: 9},
          {nombre: 'Marcela Vélez', foto: 'https://randomuser.me/api/portraits/women/8.jpg', experiencia: 6},
          {nombre: 'Dr. Pablo', foto: 'https://randomuser.me/api/portraits/men/20.jpg', experiencia: 15}
        ]
      },
      abogados: {
        titulo: 'Abogados',
        ...
        profesionales: [
          {nombre: 'Gabriel Herrera', foto: 'https://randomuser.me/api/portraits/men/13.jpg', experiencia: 18},
          {nombre: 'Hugo Martínez', foto: 'https://randomuser.me/api/portraits/men/14.jpg', experiencia: 10},
          {nombre: 'Abogada Luz', foto: 'https://randomuser.me/api/portraits/women/15.jpg', experiencia: 7}
        ]
      },
      docentes: {
        ...
        profesionales: [
          {nombre: 'Isabel Castro', foto: 'https://randomuser.me/api/portraits/women/9.jpg', experiencia: 11},
          {nombre: 'Martha Jiménez', foto: 'https://randomuser.me/api/portraits/women/10.jpg', experiencia: 14},
          {nombre: 'Profesor Mario', foto: 'https://randomuser.me/api/portraits/men/21.jpg', experiencia: 20}
        ]
      }
    };
